...
//
//public class EditarContato implements HttpHandler {
//    @Override
...
//            // Adiciona um log indicando a recepção da requisição PUT
//            System.out.println("Requisição PUT para editarContato recebida.");
//
...
//            Gson gson = new Gson();
//            Contato contatoAtualizado = gson.fromJson(jsonData, Contato.class);
//
//            // Adiciona um log indicando os dados recebidos
//            System.out.println("Dados recebidos para edição: " + jsonData);
//
//            // Validar se os dados necessários não são nulos
//            if (contatoAtualizado.getId() != 0) {
//                ContatosController contatosController = new ContatosController();
//                try {
//                    contatosController.editarContato(contatoAtualizado);
//                    System.out.println("Contato Editado com Sucesso!");
//
//                    // Adiciona uma resposta ao cliente indicando sucesso
//                    String response = "Contato Editado com Sucesso!";
...
//                    String response = "Erro ao editar contato: " + e.getMessage();
...
//                }
//            } else {
//                System.out.println("Dados insuficientes para editar o contato.");
//
//                // Adiciona uma resposta ao cliente indicando dados insuficientes
//                String response = "Dados insuficientes para editar o contato.";
